---
layout: post
title: "GW-R86S-U1 with Mellanox ConnectX-4 MCX4421A-ACQN"
date: 2025-11-29 20:00:00 -0300
categories: [homelab, networking]
tags: [gw-r86s, mellanox, connectx-4, 25gbe, pcie]
---
...
I've established this post to document the upgrade process of my GW-R86S-U1, where I'll be installing a Mellanox ConnectX-4 MCX4421A-ACQN interface.
...
As I proceed with the upgrade, I'll be sharing detailed steps and any insights I gain through this process.

## About the Mellanox ConnectX-4 MCX4421A-ACQN

> For more information about the OCP, I found this really interesting [document](https://www.opencompute.org/documents/ocp-mezz-2-0-rev1-1-20200103-nocb-pdf) from www.opencompute.org with a lot of information.
...
![Ebay MCX4421A-ACQN card used.]({{ "/assets/img/gw-r86s-u1-mcx4421a/552eed7eb070f074.png" | relative_url }})
...
![MCX4421A-ACQN card.]({{ "/assets/img/gw-r86s-u1-mcx4421a/7f4baf08b8713a04.gif" | relative_url }})
...
1. Get the NVIDIA Firmware Tools (MFT) from here:  
   <https://network.nvidia.com/products/adapter-software/firmware-tools/>

2. As root, start the mst tools with:

    ```bash
    sudo mst start
    ```

![cmd1]({{ "/assets/img/gw-r86s-u1-mcx4421a/35a7c2ba0b40c5bb-1.png" | relative_url }})

3. To verify the Part Number (OPN), the PSID, and the PCI device name, execute the command:

    ```bash
    sudo mlxfwmanager
    ```

![cmd2]({{ "/assets/img/gw-r86s-u1-mcx4421a/35a7c2ba0b40c5bb-2.png" | relative_url }})

4. Once you have obtained the OPN and PSID, proceed to download the official firmware for your device from the following link:  
   <https://network.nvidia.com/support/firmware/connectx4lxen/>.

![cmd3]({{ "/assets/img/gw-r86s-u1-mcx4421a/35a7c2ba0b40c5bb-3.png" | relative_url }})

5. Burn the firmware:

    ```bash
    sudo mlxburn -i <fw-ConnectX-4-downloaded>.bin -d /dev/mst/<PCI-device-name>
    ```

![cmd4]({{ "/assets/img/gw-r86s-u1-mcx4421a/35a7c2ba0b40c5bb-4.png" | relative_url }})

## Change the CX341A interface card

1. Remove the four lateral screws.

![rem1]({{ "/assets/img/gw-r86s-u1-mcx4421a/eff6bb60850e0922-1.png" | relative_url }})

![rem2]({{ "/assets/img/gw-r86s-u1-mcx4421a/eff6bb60850e0922-2.png" | relative_url }})

2. Slowly open the case and disconnect PCI flex + power cable (NOT the battery).

![rem3]({{ "/assets/img/gw-r86s-u1-mcx4421a/eff6bb60850e0922-3.png" | relative_url }})

3. Remove the screws and take out the card.

![rem4]({{ "/assets/img/gw-r86s-u1-mcx4421a/eff6bb60850e0922-4.png" | relative_url }})

4. Comparison:

![rem5]({{ "/assets/img/gw-r86s-u1-mcx4421a/eff6bb60850e0922-5.png" | relative_url }})

![rem6]({{ "/assets/img/gw-r86s-u1-mcx4421a/eff6bb60850e0922-6.png" | relative_url }})

![rem7]({{ "/assets/img/gw-r86s-u1-mcx4421a/eff6bb60850e0922-7.png" | relative_url }})
...
![rem8]({{ "/assets/img/gw-r86s-u1-mcx4421a/eff6bb60850e0922-8.png" | relative_url }})

![rem9]({{ "/assets/img/gw-r86s-u1-mcx4421a/eff6bb60850e0922-9.png" | relative_url }})
...
![equ1]({{ "/assets/img/gw-r86s-u1-mcx4421a/440071a96d495743-1.png" | relative_url }})

![equ2]({{ "/assets/img/gw-r86s-u1-mcx4421a/440071a96d495743-3.png" | relative_url }})

![equ3]({{ "/assets/img/gw-r86s-u1-mcx4421a/440071a96d495743-4.png" | relative_url }})
